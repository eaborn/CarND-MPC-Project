    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          *
          */
          vector<double> waypoints_x_car;
          vector<double> waypoints_y_car;
          ...
          for (int i = 0; i < ptsx.size(); i++) {
            // transform from map coordinate into car coordinate
            double dx = ptsx[i] - px;
            double dy = ptsy[i] - py;
          ...
          double* ptrx = &waypoints_x_car[0];
          double* ptry = &waypoints_y_car[0];
